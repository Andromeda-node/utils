...
source <(curl -s https://raw.githubusercontent.com/Andromeda-node/utils/main/colorpath.sh)
...
for (( ; ; )); do
  ...
  if ((height >= TARGET_BLOCK)); then
    bash <(curl -s https://raw.githubusercontent.com/Andromeda-node/orai/main/upgrade.sh)
